...
#Static files dir para las imagenes
#STATICFILES_DIRS = [
#    BASE_DIR / "static",  # opcional si tienes static global
#]

#Aqui termina static files dir
...
DEFAULT_FROM_EMAIL = 'no-reply@code4boxing.com'